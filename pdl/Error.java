...
class Error {
	...
	public void getError() {
		...
		case 107 -> {
			error = st.append("- Error Léxico: El numero " + mensaje + ". Supera el maximo entero valido (32767). En la línea: ").append(línea).toString();
			System.out.println(error);
			break;
		}
		case 108 -> {
		...
		case 212 -> {
			error = st.append("- Error Sintáctico: Error al definir los parametros de la funcion. En la línea: ").append(línea).toString();
			System.out.println(error);
			break;
		}
		case 213 -> {
		...
		case 309 -> {
			error = st.append("- Error Semántico: El numero de parametros al llamar la funcion no coincide con el de la funcion: ").append(mensaje).append(". En la línea: ").append(línea).toString();
		    System.out.println(error);
		    break;
		}
		case 310 -> {
